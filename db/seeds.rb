...
# event.save
# # preferences
Preference.create(user_id: 1, name: 'Pierre', content: %w[Action Comedy Horror])
Preference.create(user_id: 2, name: 'Bob', content: %w[Adventure Family Horror])
Preference.create(user_id: 2, name: 'Fred', content: %w[Adventure Comedy Horror])
Preference.create(user_id: 4, name: 'John', content: %w[Adventure Drama Western])
